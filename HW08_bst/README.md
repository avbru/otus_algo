...
- N=1000__sorted_insert 1242373 ns/op
- N=1000__sorted_search 267 ns/op
- N=1000__sorted_delete 268 ns/op
- N=1000__random_insert 31335 ns/op
- N=1000__random_search 12 ns/op
- N=1000__random_delete 32 ns/op

При добавлении упорядоченных элементов бинарное дерево вырождается в связанный список - O(N)
При добавлении неупорядоченных сложность операций: ~O(log(N))

### Задание. Двоичное дерево поиска, АВЛ и Декартово дерево
